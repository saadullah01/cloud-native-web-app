import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.9006220b.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h1, "class", "text-yellow-600 svelte-1hvtpt5");
			add_location(h1, file, 41, 0, 501);
			attr_dev(img, "alt", "Success Kid");
			if (img.src !== (img_src_value = successkid)) attr_dev(img, "src", img_src_value);
			attr_dev(img, "class", "svelte-1hvtpt5");
			add_location(img, file, 44, 1, 560);
			add_location(figcaption, file, 45, 1, 604);
			attr_dev(figure, "class", "svelte-1hvtpt5");
			add_location(figure, file, 43, 0, 550);
			add_location(strong, file, 48, 3, 665);
			attr_dev(p, "class", "svelte-1hvtpt5");
			add_location(p, file, 48, 0, 662);
		},
