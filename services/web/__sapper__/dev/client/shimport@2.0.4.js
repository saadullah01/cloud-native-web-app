var __shimport__ = (function (n) {
  ...
  function x(n, r) {
    ...
    var s = Array.from(f.keys())
        .map(function (n) {
          return "'" + n + "'";
        })
        .join(", "),
      c = ["__import", "__exports"].concat(Array.from(f.values())).join(", "),
      l = [];
    u.forEach(function (n) {
