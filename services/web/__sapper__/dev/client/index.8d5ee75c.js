...
function create_each_block(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx, dirty) {
      ...
      if (
        dirty & /*posts*/ 1 &&
        a_href_value !== (a_href_value = "blog/" + /*post*/ ctx[1].slug)
      ) {
